  ...
  \***********************/
            ...
            /***/ function (module, exports) {
                ...
                $('#inner-page-1').owlCarousel({
                    ...
                    nav: true,
                    navText: [
                        "<img src='../assets/img/svg/ArrowRight.svg'>",
                        "<img src='../assets/img/svg/ArrowLeft.svg'>",
                    ],
                    responsive: {
                        0: {
                            items: 1,
                ...
                $(document).ready(function () {
                    $('.burger-icon-otr').css('cursor', 'pointer');
                    ...
                    $('#myNav').click(function (e) {
                        if (e.target.id == 'myNav') {
                            $('.modal-content-custom').removeClass('active');
                            $('.overlay-content-otr').removeClass(
                    ...
                    $('.zoomed-img-container').on('click', function() {
                        $('.zoomed-img-container').css('display', 'none');
                    });
                });
                $(document).ready(function () {
                    ...
                    $('.burger-icon').click(function () {
                        $('.overlay-content-otr-dark').addClass(
                            'active-overlay-content-otr'
                        );
                    });
                    $('.icon-close').click(function () {
                        $('.overlay-content-otr-dark').removeClass(
                            'active-overlay-content-otr'
                        );
                    });
                });
    ...
    \*************************************************/
            ...
            /***/ function (module, exports, __webpack_require__) {
                __webpack_require__(
                    /*! G:\Ethoz New\Ethoz-Light\src\js\app.js */ './src/js/app.js'
                );
                module.exports = __webpack_require__(
                    /*! G:\Ethoz New\Ethoz-Light\src\scss\app.scss */ './src/scss/app.scss'
                );
...
function generateSelectDropdown(ele) {
    destroySelectDropdown(ele);
    var $this = ele,
        numberOfOptions = ele.children('option').length;
...
function destroySelectDropdown(ele) {
    ele.next().remove();
    ele.next().remove();
}
