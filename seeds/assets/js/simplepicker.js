    ...
    '0DyV': function (e, t, i) {
        ...
        function r(e) {
            ...
            (e = new Date(e.getTime())).setDate(1),
                (t.monthTracker.years[r][s] = []);
            for (
                var c = t.monthTracker.years[r][s], o = 0;
                e.getMonth() === s;
            ...
            c = (function () {
                function e(e, t) {
                    ...
                    if ('string' == typeof e) {
                        ...
                        if (null === r)
                            throw new Error(
                                'Invalid selector passed to SimplePicker!'
                            );
                        i = r;
                    } else
                ...
                return (
                    ...
                    (e.prototype.init = function (e, t) {
                        ...
                        (this.$simplepicker = i('.simpilepicker-date-picker')),
                            ...
                            (this.$headerMonthAndYear = i(
                                '.simplepicker-month-and-year'
                            )),
                            (this.$monthAndYear = i(
                            ...
                            this.render(n.scrapeMonth(a)),
                            (t = t || {}),
                            (this.opts = t),
                            this.reset(t.selectedDate || a),
                            void 0 !== t.zIndex &&
                                (this.$simplepickerWrapper.style.zIndex =
                                    t.zIndex.toString()),
                    ...
                    (e.prototype.reset = function (e) {
                        ...
                        (this.$timeInput.value = i),
                            (this.$time.innerText =
                                n.formatTimeFromInputElement(i));
                        var r = t.getDate().toString(),
                            s = this.findElementWithDate(r);
                        s.classList.contains('active') ||
                            (this.selectDateElement(s),
                            this.updateDateComponents(t));
                    }),
                    ...
                    (e.prototype.handleIconButtonClick = function (e) {
                        var t,
                            i = this.$;
                        if (
                            e.classList.contains('simplepicker-icon-calender')
                        ) {
                            var r = i('.simplepicker-icon-time'),
                                s = i('.simplepicker-time-section');
                            return (
                                ((c = i(
                                    '.simplepicker-calender-section'
                                )).style.display = 'block'),
                    ...
                    (e.prototype.initListeners = function () {
                        ...
                        t.addEventListener('click', function (e) {
                            ...
                            i.addEventListener('input', function (e) {
                                if ('' !== e.target.value) {
                                    var t = n.formatTimeFromInputElement(
                                        e.target.value
                                    );
                                    (c.$time.innerHTML = t),
