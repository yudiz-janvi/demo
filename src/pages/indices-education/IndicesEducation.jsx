...
// IMAGES START
import BannerImage from '../../assets/images/indices-education-banner.jpg';
    ...
    return (
        <div className='content-wrapper' id='content-wrap'>
            ...
            <section className='education-section education-bottom-logo'>
                ...
                <LogoAnimation />
                <Container>
                    <h2>Top topics for Indices Education</h2>
...
export default IndicesEducation;
