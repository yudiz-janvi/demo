...
// IMAGES START
import BannerVideo from '../../assets/video/etfs-banner.mp4';
...
import StepCover from '../../assets/images/etfs-cover.png';
...
import DirexionIcon from '../../assets/images/direxion-icon.png';
import ProshareIcon from '../../assets/images/etfs-icon1.png';
import Spdrcon from '../../assets/images/spdr-icon.png';
import VanguardEnergIcon from '../../assets/images/vanguard-energy-icon.png';
import Etfs3Icon from '../../assets/images/etfs-icon3.png';
...
function Etfs() {
    ...
    const ForexData = [
        {
            instrument: { text: 'Gold', url: tslaIcon },
            sell: '1.082',
            buy: '0.16%',
            change: '0.006',
        },
        {
            instrument: { text: 'Us crude', url: AppleStockIcon },
            sell: '1.082',
            buy: '0.16%',
            change: '0.006',
        },
        {
            instrument: { text: 'Silver', url: MicrosoftIcon },
            sell: '1.082',
            buy: '0.16%',
            change: '0.006',
        },
        {
            instrument: { text: 'Natural Gas', url: DirexionIcon },
            sell: '1.082',
            buy: '0.16%',
            change: '0.006',
        },
        {
            instrument: { text: 'Coffee', url: ProshareIcon },
            sell: '1.082',
            buy: '0.16%',
            change: '0.006',
        },
    ...
    return (
        <div className='content-wrapper' id='content-wrap'>
            <InnerBanner bannerData={bannerData} active_page='ETFS' />
            {/* Forex Trade START */}
                            ...
                            >
                                <div className='currency-icon icon-1'>
                                    <div className='currency-icon-inner'>
                                        <img src={Etfs3Icon} alt='Etfs3Icon' />
                                    </div>
                                </div>
