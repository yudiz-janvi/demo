...
// IMAGES START
import BannerImage from '../../assets/images/commodities-education-banner.jpg';
...
function CommoditiesEducation() {
    ...
    const bannerData = {
        ...
        page_title: 'Commodities Education',
        description:
    ...
    return (
        <div className='content-wrapper' id='content-wrap'>
            ...
            <section className='education-section education-bottom-logo'>
                ...
                <LogoAnimation />
                <Container>
                    <h2>Top topics for Commodities Education</h2>
...
export default CommoditiesEducation;
