...
// IMAGES START
import BannerVideo from '../../assets/video/commodities-banner.mp4';
...
import StepCover from '../../assets/images/commodities-cover.jpg';
...
import UsCrudeIcon from '../../assets/images/us-crude-icon.png';
import SilverIcon from '../../assets/images/silver-icon.png';
import Gold2Icon from '../../assets/images/gold2-icon.png';
import CoffeeIcon from '../../assets/images/coffee-icon.png';
import NaturalGasIcon from '../../assets/images/natural-gas-icon.png';
...
function Commodities() {
    ...
    const ForexData = [
        {
            instrument: { text: 'Gold', url: Gold2Icon },
            sell: '1.082',
            buy: '0.16%',
            change: '0.006',
        },
        {
            instrument: { text: 'Us crude', url: UsCrudeIcon },
            sell: '1.082',
            buy: '0.16%',
            change: '0.006',
        },
        {
            instrument: { text: 'Silver', url: SilverIcon },
            sell: '1.082',
            buy: '0.16%',
            change: '0.006',
        },
        {
            instrument: { text: 'Natural Gas', url: NaturalGasIcon },
            sell: '1.082',
            buy: '0.16%',
            change: '0.006',
        },
        {
            instrument: { text: 'Coffee', url: CoffeeIcon },
            sell: '1.082',
            buy: '0.16%',
            change: '0.006',
        },
    ...
    return (
        <div className='content-wrapper' id='content-wrap'>
            <InnerBanner bannerData={bannerData} active_page='Commodities' />
            {/* Forex Trade START */}
                        ...
                        >
                            ...
                            >
                                ...
                                <div className='currency-icon icon-4'>
                                    <div className='currency-icon-inner'>
                                        <img src={Gold2Icon} alt='Gold2Icon' />
                                    </div>
                                </div>
            ...
            {/* FAQS SECTION START */}
            <section className='faqs-section-wrap' data-aos='fade-up'>
                <Container>
