...
// IMAGES START
import BannerVideo from '../../assets/video/indicies-banner.mp4';
...
import NdaqLogo from '../../assets/images/ndaq-logo.png';
import StepCover from '../../assets/images/indices-cover.jpg';
...
import UsMarketLogo from '../../assets/images/us-market-icon.png';
import UkMarketLogo from '../../assets/images/uk-market-icon.png';
import FtseIcon from '../../assets/images/ftse-icon.png';
import NasdaqIcon from '../../assets/images/nasdaq-icon.png';
import Sp500Icon from '../../assets/images/sp-500-icon.png';
import DaxIcon from '../../assets/images/dax-icon.png';
import DowJonesIcon from '../../assets/images/dow-jones-icon.png';
...
function Indices() {
    ...
    const ForexData = [
        {
            instrument: { text: 'FTSE', url: FtseIcon },
            sell: '1.082',
            buy: '0.16%',
            change: '0.006',
        },
        {
            instrument: { text: 'S&P 500', url: Sp500Icon },
            sell: '1.082',
            buy: '0.16%',
            change: '0.006',
        },
        {
            instrument: { text: 'Dow Jones', url: DowJonesIcon },
            sell: '1.082',
            buy: '0.16%',
            change: '0.006',
        },
        {
            instrument: { text: 'German Dax', url: DaxIcon },
            sell: '1.082',
            buy: '0.16%',
            change: '0.006',
        },
        {
            instrument: { text: 'Nasdaq', url: NasdaqIcon },
            sell: '1.082',
            buy: '0.16%',
            change: '0.006',
        },
    ...
    return (
        <div className='content-wrapper' id='content-wrap'>
            <InnerBanner bannerData={bannerData} active_page='Indices' />
            {/* Forex Trade START */}
            ...
            <section className='live-market-section '>
                ...
                >
                    <Container className='position-relative'>
                            ...
                            >
                                <div className='currency-icon icon-1'>
                                    <div className='currency-icon-inner'>
                                        <img src={FtseIcon} alt='FtseIcon' />
                                    </div>
                                </div>
                                <div className='currency-icon icon-2'>
                                    <div className='currency-icon-inner'>
                                        <img src={Sp500Icon} alt='Sp500Icon' />
                                    </div>
                                </div>
                        ...
                        <div className='live-market-inside' data-aos='fade-up'>
